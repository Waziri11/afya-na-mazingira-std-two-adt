# Afya na Mazingira — ADT Bundle Reference
...
**Afya na Mazingira** — Kitabu hiki cha Afya na Mazingira ni cha mwanafunzi wa Darasa la Pili na kinahusu maarifa ya msingi kuhusu mazingira, viumbehai na vitu visivyo hai, alama za usalama, pamoja na usafi na utunzaji wa mazingira kwa kupanda miti na maua. Kimeandaliwa Tanzania na Taasisi ya Elimu Tanzania, hivyo kinaelekezwa kwa wanafunzi wa elimu ya msingi ya awali nchini humo, na kimeandikwa kwa lugha ya Kiswahili. Kwa ujumla, kitabu kinatumia mbinu shirikishi na za vitendo kama uchunguzi, maswali, nyimbo, mashairi, hadithi na matumizi ya TEHAMA ili kuwajengea watoto tabia za afya, usalama na uwajibikaji kwa mazingira yao.
...
```
AFYA-NA-MAZINGIRA-STD-TWO-2-2024/
├── adt/                              # THE WEB APP
...
├── AFYA-NA-MAZINGIRA-STD-TWO-2-2024.db                    # SQLite database (pipeline state)
├── AFYA-NA-MAZINGIRA-STD-TWO-2-2024.pdf                   # Original source PDF
...
[
  ...
  { "section_id": "pg007_sec002", "href": "pg007_sec002.html", "page_number": 1 }
]
```
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha ithibati cha kitabu cha Afya na Mazingira Darasa la Pili kutoka Wizara ya Elimu, Sayansi na Teknolojia ya Tanzania.",
  "gl001": "afya",
  "gl001_def": "hali ya mwili na akili kuwa salama na bila ugonjwa",
  "qz001_que": "Kipi kati ya hivi ni kiumbehai?",
  "qz001_o0": "1) gari",
  "qz001_o0_exp": "❌ Gari si kiumbehai. Ni kitu kisicho hai katika mazingira."
}
```
...
```json
{
  "afya": {
    "word": "afya",
    "definition": "hali ya mwili na akili kuwa salama na bila ugonjwa",
    "variations": ["afya"],
    "emoji": "🩺💪"
  }
}
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Kipi kati ya hivi ni kiumbehai?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Gari si kiumbehai. Ni kitu kisicho hai katika mazingira." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) gari</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `AFYA-NA-MAZINGIRA-STD-TWO-2-2024.pdf` |
| Pipeline database | `AFYA-NA-MAZINGIRA-STD-TWO-2-2024.db` (SQLite) |
